...
export type SetCropType = {
    type: 'SET_CROP'
    crop?: CropType
}

export const setCrop = (crop?: CropType): SetCropType => ({
    type: 'SET_CROP',
    crop
})
...
export type ProcessActionTypes = InitPixelsType | SolvedPixelType | SetPreviewType | LoadProcessStateType | ChangePositionType | InterpolateType | InterpolateAllType | DeleteLowConfidenceType | SetCropType
