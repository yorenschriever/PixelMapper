 ...
 */
  function Canny(image: InputArray, edges: OutputArray, threshold1: double, threshold2: double, apertureSize?: int, L2gradient?: bool): void
 ...
 * the default $L_1$ norm $=|dI/dx|+|dI/dy|$ is enough ( L2gradient=false ).
 */
  function Canny(dx: InputArray, dy: InputArray, edges: OutputArray, threshold1: double, threshold2: double, L2gradient?: bool): void
 ...
 */
  function cornerEigenValsAndVecs(src: InputArray, dst: OutputArray, blockSize: int, ksize: int, borderType?: int): void
 ...
 * @param borderType Pixel extrapolation method. See BorderTypes.
 */
  function cornerHarris(src: InputArray, dst: OutputArray, blockSize: int, ksize: int, k: double, borderType?: int): void
 ...
 * @param borderType Pixel extrapolation method. See BorderTypes.
 */
  function cornerMinEigenVal(src: InputArray, dst: OutputArray, blockSize: int, ksize?: int, borderType?: int): void
 ...
 */
  function cornerSubPix(image: InputArray, corners: InputOutputArray, winSize: Size, zeroZone: Size, criteria: TermCriteria): void
 ...
 */
  function createLineSegmentDetector(_refine?: int, _scale?: double, _sigma_scale?: double, _quant?: double, _ang_th?: double, _log_eps?: double, _density_th?: double, _n_bins?: int): any
 ...
 */
  function goodFeaturesToTrack(image: InputArray, corners: OutputArray, maxCorners: int, qualityLevel: double, minDistance: double, mask?: InputArray, blockSize?: int, useHarrisDetector?: bool, k?: double): void

  function goodFeaturesToTrack(image: InputArray, corners: OutputArray, maxCorners: int, qualityLevel: double, minDistance: double, mask: InputArray, blockSize: int, gradientSize: int, useHarrisDetector?: bool, k?: double): void
 ...
 */
  function HoughCircles(image: InputArray, circles: OutputArray, method: int, dp: double, minDist: double, param1?: double, param2?: double, minRadius?: int, maxRadius?: int): void
 ...
 */
  function HoughLines(image: InputArray, lines: OutputArray, rho: double, theta: double, threshold: int, srn?: double, stn?: double, min_theta?: double, max_theta?: double): void
 ...
 */
  function HoughLinesP(image: InputArray, lines: OutputArray, rho: double, theta: double, threshold: int, minLineLength?: double, maxLineGap?: double): void
 ...
 */
  function HoughLinesPointSet(_point: InputArray, _lines: OutputArray, lines_max: int, threshold: int, min_rho: double, max_rho: double, rho_step: double, min_theta: double, max_theta: double, theta_step: double): void
 ...
 * @param borderType Pixel extrapolation method. See BorderTypes.
 */
  function preCornerDetect(src: InputArray, dst: OutputArray, ksize: int, borderType?: int): void
 ...
 * 
 */
  const HOUGH_STANDARD: HoughModes // initializer: = 0
 ...
 * 
 */
  const HOUGH_PROBABILISTIC: HoughModes // initializer: = 1
 ...
 * 
 */
  const HOUGH_MULTI_SCALE: HoughModes // initializer: = 2

  const HOUGH_GRADIENT: HoughModes // initializer: = 3

  const LSD_REFINE_NONE: LineSegmentDetectorModes // initializer: = 0

  const LSD_REFINE_STD: LineSegmentDetectorModes // initializer: = 1
 ...
 * 
 */
  const LSD_REFINE_ADV: LineSegmentDetectorModes // initializer: = 2
