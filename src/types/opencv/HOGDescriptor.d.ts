 ...
 */
  ...
  const DEFAULT_NLEVELS: any // initializer: = 64

  const DESCR_FORMAT_COL_BY_COL: DescriptorStorageFormat // initializer: 

  const DESCR_FORMAT_ROW_BY_ROW: DescriptorStorageFormat // initializer: 

  const L2Hys: HistogramNormType // initializer: = 0
