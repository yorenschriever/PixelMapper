 ...
 */
  function hal_ni_dct2D(context: cvhalDFT, src_data: uchar, src_step: size_t, dst_data: uchar, dst_step: size_t): cvhalDFT

/**
 * @param context pointer to context storing all necessary data
 */
  function hal_ni_dctFree2D(context: cvhalDFT): cvhalDFT
 ...
 */
  function hal_ni_dctInit2D(context: cvhalDFT, width: int, height: int, depth: int, flags: int): cvhalDFT
 ...
 */
  function hal_ni_dft1D(context: cvhalDFT, src: uchar, dst: uchar): cvhalDFT
 ...
 * @param dst_data destination image data and step
 */
  function hal_ni_dft2D(context: cvhalDFT, src_data: uchar, src_step: size_t, dst_data: uchar, dst_step: size_t): cvhalDFT

/**
 * @param context pointer to context storing all necessary data
 */
  function hal_ni_dftFree1D(context: cvhalDFT): cvhalDFT

/**
 * @param context pointer to context storing all necessary data
 */
  function hal_ni_dftFree2D(context: cvhalDFT): cvhalDFT
 ...
 */
  function hal_ni_dftInit1D(context: cvhalDFT, len: int, count: int, depth: int, flags: int, needBuffer: any): cvhalDFT
 ...
 */
  function hal_ni_dftInit2D(context: cvhalDFT, width: int, height: int, depth: int, src_channels: int, dst_channels: int, flags: int, nonzero_rows: int): cvhalDFT
 ...
 */
  function hal_ni_minMaxIdx(src_data: uchar, src_step: size_t, width: int, height: int, depth: int, minVal: any, maxVal: any, minIdx: any, maxIdx: any, mask: uchar): uchar
