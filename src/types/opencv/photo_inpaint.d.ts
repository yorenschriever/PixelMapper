 ...
 */
  function inpaint(src: InputArray, inpaintMask: InputArray, dst: OutputArray, inpaintRadius: double, flags: int): void

  const INPAINT_NS: any // initializer: = 0

  const INPAINT_TELEA: any // initializer: = 1
