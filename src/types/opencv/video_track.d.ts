 ...
 * force data copying.
 */
  function buildOpticalFlowPyramid(img: InputArray, pyramid: OutputArrayOfArrays, winSize: Size, maxLevel: int, withDerivatives?: bool, pyrBorder?: int, derivBorder?: int, tryReuseInputImage?: bool): int
 ...
 */
  function calcOpticalFlowFarneback(prev: InputArray, next: InputArray, flow: InputOutputArray, pyr_scale: double, levels: int, winsize: int, iterations: int, poly_n: int, poly_sigma: double, flags: int): void
 ...
 * performance boost.
 */
  function calcOpticalFlowPyrLK(prevImg: InputArray, nextImg: InputArray, prevPts: InputArray, nextPts: InputOutputArray, status: OutputArray, err: OutputArray, winSize?: Size, maxLevel?: int, criteria?: TermCriteria, flags?: int, minEigThreshold?: double): void
 ...
 */
  function CamShift(probImage: InputArray, window: any, criteria: TermCriteria): RotatedRect
 ...
 */
  function computeECC(templateImage: InputArray, inputImage: InputArray, inputMask?: InputArray): double
 ...
 */
  function estimateRigidTransform(src: InputArray, dst: InputArray, fullAffine: bool): Mat
 ...
 */
  function findTransformECC(templateImage: InputArray, inputImage: InputArray, warpMatrix: InputOutputArray, motionType: int, criteria: TermCriteria, inputMask: InputArray, gaussFiltSize: int): double

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function findTransformECC(templateImage: InputArray, inputImage: InputArray, warpMatrix: InputOutputArray, motionType?: int, criteria?: TermCriteria, inputMask?: InputArray): double
 ...
 */
  function meanShift(probImage: InputArray, window: any, criteria: TermCriteria): int
 ...
 */
  function readOpticalFlow(path: any): Mat
 ...
 */
  function writeOpticalFlow(path: any, flow: InputArray): bool

  const OPTFLOW_USE_INITIAL_FLOW: any // initializer: = 4

  const OPTFLOW_LK_GET_MIN_EIGENVALS: any // initializer: = 8

  const OPTFLOW_FARNEBACK_GAUSSIAN: any // initializer: = 256

  const MOTION_TRANSLATION: any // initializer: = 0

  const MOTION_EUCLIDEAN: any // initializer: = 1

  const MOTION_AFFINE: any // initializer: = 2

  const MOTION_HOMOGRAPHY: any // initializer: = 3
