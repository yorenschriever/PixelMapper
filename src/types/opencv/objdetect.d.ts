 ...
 */
  function createFaceDetectionMaskGenerator(): any
 ...
 */
  function groupRectangles(rectList: any, groupThreshold: int, eps?: double): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function groupRectangles(rectList: any, weights: any, groupThreshold: int, eps?: double): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function groupRectangles(rectList: any, groupThreshold: int, eps: double, weights: any, levelWeights: any): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function groupRectangles(rectList: any, rejectLevels: any, levelWeights: any, groupThreshold: int, eps?: double): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function groupRectangles_meanshift(rectList: any, foundWeights: any, foundScales: any, detectThreshold?: double, winDetSize?: Size): void

  const CASCADE_DO_CANNY_PRUNING: any // initializer: = 1

  const CASCADE_SCALE_IMAGE: any // initializer: = 2

  const CASCADE_FIND_BIGGEST_OBJECT: any // initializer: = 4

  const CASCADE_DO_ROUGH_SEARCH: any // initializer: = 8
