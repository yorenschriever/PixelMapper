 ...
 */
  function calcBackProject(images: any, nimages: int, channels: any, hist: InputArray, backProject: OutputArray, ranges: any, scale?: double, uniform?: bool): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function calcBackProject(images: any, nimages: int, channels: any, hist: any, backProject: OutputArray, ranges: any, scale?: double, uniform?: bool): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function calcBackProject(images: InputArrayOfArrays, channels: any, hist: InputArray, dst: OutputArray, ranges: any, scale: double): void
 ...
 */
  function calcHist(images: any, nimages: int, channels: any, mask: InputArray, hist: OutputArray, dims: int, histSize: any, ranges: any, uniform?: bool, accumulate?: bool): void
 ...
 */
  function calcHist(images: any, nimages: int, channels: any, mask: InputArray, hist: any, dims: int, histSize: any, ranges: any, uniform?: bool, accumulate?: bool): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function calcHist(images: InputArrayOfArrays, channels: any, mask: InputArray, hist: OutputArray, histSize: any, ranges: any, accumulate?: bool): void
 ...
 */
  function compareHist(H1: InputArray, H2: InputArray, method: int): double

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function compareHist(H1: any, H2: any, method: int): double
 ...
 */
  function createCLAHE(clipLimit?: double, tileGridSize?: Size): any
 ...
 */
  function EMD(signature1: InputArray, signature2: InputArray, distType: int, cost?: InputArray, lowerBound?: any, flow?: OutputArray): float
 ...
 */
  function equalizeHist(src: InputArray, dst: OutputArray): void

  function wrapperEMD(signature1: InputArray, signature2: InputArray, distType: int, cost?: InputArray, lowerBound?: any, flow?: OutputArray): float
 ...
 * 
 */
  const HISTCMP_CORREL: HistCompMethods // initializer: = 0

/**
 * Chi-Square `\\[d(H_1,H_2) = \\sum _I \\frac{\\left(H_1(I)-H_2(I)\\right)^2}{H_1(I)}\\]`
 * 
 */
  const HISTCMP_CHISQR: HistCompMethods // initializer: = 1

/**
 * Intersection `\\[d(H_1,H_2) = \\sum _I \\min (H_1(I), H_2(I))\\]`
 * 
 */
  const HISTCMP_INTERSECT: HistCompMethods // initializer: = 2
 ...
 * 
 */
  const HISTCMP_BHATTACHARYYA: HistCompMethods // initializer: = 3

  const HISTCMP_HELLINGER: HistCompMethods // initializer: = HISTCMP_BHATTACHARYYA
 ...
 * 
 */
  const HISTCMP_CHISQR_ALT: HistCompMethods // initializer: = 4
 ...
 * 
 */
  const HISTCMP_KL_DIV: HistCompMethods // initializer: = 5
