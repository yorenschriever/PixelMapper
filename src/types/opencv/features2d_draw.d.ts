 ...
 */
  function drawKeypoints(image: InputArray, keypoints: any, outImage: InputOutputArray, color?: any, flags?: DrawMatchesFlags): void
 ...
 * DrawMatchesFlags.
 */
  function drawMatches(img1: InputArray, keypoints1: any, img2: InputArray, keypoints2: any, matches1to2: any, outImg: InputOutputArray, matchColor?: any, singlePointColor?: any, matchesMask?: any, flags?: DrawMatchesFlags): void
 ...
 * 
 */
  const DEFAULT: DrawMatchesFlags // initializer: = 0
 ...
 * 
 */
  const DRAW_OVER_OUTIMG: DrawMatchesFlags // initializer: = 1

  const NOT_DRAW_SINGLE_POINTS: DrawMatchesFlags // initializer: = 2

/**
 * For each keypoint the circle around keypoint with keypoint size and orientation will be drawn.
 * 
 */
  const DRAW_RICH_KEYPOINTS: DrawMatchesFlags // initializer: = 4
