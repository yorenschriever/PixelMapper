 ...
 */
  function blobFromImage(image: InputArray, scalefactor?: double, size?: any, mean?: any, swapRB?: bool, crop?: bool, ddepth?: int): Mat

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function blobFromImage(image: InputArray, blob: OutputArray, scalefactor?: double, size?: any, mean?: any, swapRB?: bool, crop?: bool, ddepth?: int): void
 ...
 * @param ddepth Depth of output blob. Choose CV_32F or CV_8U.
 */
  function blobFromImages(images: InputArrayOfArrays, scalefactor?: double, size?: Size, mean?: any, swapRB?: bool, crop?: bool, ddepth?: int): Mat

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function blobFromImages(images: InputArrayOfArrays, blob: OutputArray, scalefactor?: double, size?: Size, mean?: any, swapRB?: bool, crop?: bool, ddepth?: int): void

  function getAvailableBackends(): any

  function getAvailableTargets(be: Backend): any
 ...
 */
  function imagesFromBlob(blob_: any, images_: OutputArrayOfArrays): any
 ...
 */
  function NMSBoxes(bboxes: any, scores: any, score_threshold: any, nms_threshold: any, indices: any, eta?: any, top_k?: any): void
 ...
 */
  function readNet(model: any, config?: any, framework?: any): Net
 ...
 */
  function readNet(framework: any, bufferModel: uchar, bufferConfig?: uchar): uchar
 ...
 */
  function readNetFromCaffe(prototxt: any, caffeModel?: any): Net
 ...
 */
  function readNetFromCaffe(bufferProto: uchar, bufferModel?: uchar): uchar
 ...
 */
  function readNetFromCaffe(bufferProto: any, lenProto: size_t, bufferModel?: any, lenModel?: size_t): Net
 ...
 */
  function readNetFromDarknet(cfgFile: any, darknetModel?: any): Net
 ...
 */
  function readNetFromDarknet(bufferCfg: uchar, bufferModel?: uchar): uchar
 ...
 */
  function readNetFromDarknet(bufferCfg: any, lenCfg: size_t, bufferModel?: any, lenModel?: size_t): Net
 ...
 */
  function readNetFromModelOptimizer(xml: any, bin: any): Net
 ...
 */
  function readNetFromONNX(onnxFile: any): Net
 ...
 */
  function readNetFromONNX(buffer: any, sizeBuffer: size_t): Net
 ...
 */
  function readNetFromONNX(buffer: uchar): uchar
 ...
 * flexible.
 */
  function readNetFromTensorflow(model: any, config?: any): Net
 ...
 */
  function readNetFromTensorflow(bufferModel: uchar, bufferConfig?: uchar): uchar
 ...
 */
  function readNetFromTensorflow(bufferModel: any, lenModel: size_t, bufferConfig?: any, lenConfig?: size_t): Net
 ...
 * Torch.
 */
  function readNetFromTorch(model: any, isBinary?: bool, evaluate?: bool): Net
 ...
 */
  function readTensorFromONNX(path: any): Mat

/**
 * This function has the same limitations as [readNetFromTorch()].
 */
  function readTorchBlob(filename: any, isBinary?: bool): Mat
 ...
 */
  function shrinkCaffeModel(src: any, dst: any, layersTypes?: any): void
 ...
 */
  function writeTextGraph(model: any, output: any): void
 ...
 * 
 */
  const DNN_BACKEND_DEFAULT: Backend // initializer: 

  const DNN_BACKEND_HALIDE: Backend // initializer: 

  const DNN_BACKEND_INFERENCE_ENGINE: Backend // initializer: 

  const DNN_BACKEND_OPENCV: Backend // initializer: 

  const DNN_BACKEND_VKCOM: Backend // initializer: 

  const DNN_TARGET_CPU: Target // initializer: 

  const DNN_TARGET_OPENCL: Target // initializer: 

  const DNN_TARGET_OPENCL_FP16: Target // initializer: 

  const DNN_TARGET_MYRIAD: Target // initializer: 

  const DNN_TARGET_VULKAN: Target // initializer: 

  const DNN_TARGET_FPGA: Target // initializer: 
