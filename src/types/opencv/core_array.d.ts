 ...
 */
  function absdiff(src1: InputArray, src2: InputArray, dst: OutputArray): void
 ...
 */
  function add(src1: InputArray, src2: InputArray, dst: OutputArray, mask?: InputArray, dtype?: int): void
 ...
 */
  function addWeighted(src1: InputArray, alpha: double, src2: InputArray, beta: double, gamma: double, dst: OutputArray, dtype?: int): void

/**
 * see
 */
  function batchDistance(src1: InputArray, src2: InputArray, dist: OutputArray, dtype: int, nidx: OutputArray, normType?: int, K?: int, mask?: InputArray, update?: int, crosscheck?: bool): void
 ...
 * output array to be changed.
 */
  function bitwise_and(src1: InputArray, src2: InputArray, dst: OutputArray, mask?: InputArray): void
 ...
 * output array to be changed.
 */
  function bitwise_not(src: InputArray, dst: OutputArray, mask?: InputArray): void
 ...
 * output array to be changed.
 */
  function bitwise_or(src1: InputArray, src2: InputArray, dst: OutputArray, mask?: InputArray): void
 ...
 * output array to be changed.
 */
  function bitwise_xor(src1: InputArray, src2: InputArray, dst: OutputArray, mask?: InputArray): void
 ...
 */
  function calcCovarMatrix(samples: any, nsamples: int, covar: any, mean: any, flags: int, ctype?: int): void
 ...
 * @param ctype type of the matrixl; it equals 'CV_64F' by default.
 */
  function calcCovarMatrix(samples: InputArray, covar: OutputArray, mean: InputOutputArray, flags: int, ctype?: int): void
 ...
 */
  function cartToPolar(x: InputArray, y: InputArray, magnitude: OutputArray, angle: OutputArray, angleInDegrees?: bool): void
 ...
 */
  function checkRange(a: InputArray, quiet?: bool, pos?: any, minVal?: double, maxVal?: double): bool
 ...
 */
  function compare(src1: InputArray, src2: InputArray, dst: OutputArray, cmpop: int): void
 ...
 */
  function completeSymm(m: InputOutputArray, lowerToUpper?: bool): void
 ...
 */
  function convertFp16(src: InputArray, dst: OutputArray): void
 ...
 */
  function convertScaleAbs(src: InputArray, dst: OutputArray, alpha?: double, beta?: double): void
 ...
 */
  function copyMakeBorder(src: InputArray, dst: OutputArray, top: int, bottom: int, left: int, right: int, borderType: int, value?: any): void
 ...
 */
  function copyTo(src: InputArray, dst: OutputArray, mask: InputArray): void
 ...
 */
  function countNonZero(src: InputArray): int
 ...
 */
  function dct(src: InputArray, dst: OutputArray, flags?: int): void
 ...
 */
  function determinant(mtx: InputArray): double
 ...
 */
  function dft(src: InputArray, dst: OutputArray, flags?: int, nonzeroRows?: int): void
 ...
 */
  function divide(src1: InputArray, src2: InputArray, dst: OutputArray, scale?: double, dtype?: int): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function divide(scale: double, src2: InputArray, dst: OutputArray, dtype?: int): void
 ...
 * eigenvalues.
 */
  function eigen(src: InputArray, eigenvalues: OutputArray, eigenvectors?: OutputArray): bool
 ...
 */
  function eigenNonSymmetric(src: InputArray, eigenvalues: OutputArray, eigenvectors: OutputArray): void
 ...
 * @param dst output array of the same size and type as src.
 */
  function exp(src: InputArray, dst: OutputArray): void
 ...
 */
  function extractChannel(src: InputArray, dst: OutputArray, coi: int): void
 ...
 */
  function findNonZero(src: InputArray, idx: OutputArray): void
 ...
 */
  function flip(src: InputArray, dst: OutputArray, flipCode: int): void
 ...
 */
  function gemm(src1: InputArray, src2: InputArray, alpha: double, src3: InputArray, beta: double, dst: OutputArray, flags?: int): void
 ...
 * the src.
 */
  function hconcat(src: any, nsrc: size_t, dst: OutputArray): void
 ...
 */
  function hconcat(src1: InputArray, src2: InputArray, dst: OutputArray): void
 ...
 * the src. same depth.
 */
  function hconcat(src: InputArrayOfArrays, dst: OutputArray): void
 ...
 */
  function idct(src: InputArray, dst: OutputArray, flags?: int): void
 ...
 */
  function idft(src: InputArray, dst: OutputArray, flags?: int, nonzeroRows?: int): void
 ...
 */
  function inRange(src: InputArray, lowerb: InputArray, upperb: InputArray, dst: OutputArray): void
 ...
 */
  function insertChannel(src: InputArray, dst: InputOutputArray, coi: int): void
 ...
 */
  function invert(src: InputArray, dst: OutputArray, flags?: int): double
 ...
 * @param dst output array of the same size and type as src .
 */
  function log(src: InputArray, dst: OutputArray): void
 ...
 */
  function LUT(src: InputArray, lut: InputArray, dst: OutputArray): void
 ...
 */
  function magnitude(x: InputArray, y: InputArray, magnitude: OutputArray): void
 ...
 */
  function Mahalanobis(v1: InputArray, v2: InputArray, icovar: InputArray): double
 ...
 */
  function max(src1: InputArray, src2: InputArray, dst: OutputArray): void
 ...
 * const _Tp&, _Compare)
 */
  function max(src1: any, src2: any, dst: any): void
 ...
 */
  function mean(src: InputArray, mask?: InputArray): Scalar
 ...
 * @param mask optional operation mask.
 */
  function meanStdDev(src: InputArray, mean: OutputArray, stddev: OutputArray, mask?: InputArray): void
 ...
 */
  function merge(mv: any, count: size_t, dst: OutputArray): void
 ...
 */
  function merge(mv: InputArrayOfArrays, dst: OutputArray): void
 ...
 * @param dst output array of the same size and type as src1.
 */
  function min(src1: InputArray, src2: InputArray, dst: OutputArray): void
 ...
 * const _Tp&, _Compare)
 */
  function min(src1: any, src2: any, dst: any): void
 ...
 */
  function minMaxIdx(src: InputArray, minVal: any, maxVal?: any, minIdx?: any, maxIdx?: any, mask?: InputArray): void
 ...
 */
  function minMaxLoc(src: InputArray, minVal: any, maxVal?: any, minLoc?: any, maxLoc?: any, mask?: InputArray): void
 ...
 * @param maxIdx pointer to the returned maximum location (in nD case). NULL is used if not required.
 */
  function minMaxLoc(a: any, minVal: any, maxVal: any, minIdx?: any, maxIdx?: any): void
 ...
 */
  function mixChannels(src: any, nsrcs: size_t, dst: any, ndsts: size_t, fromTo: any, npairs: size_t): void
 ...
 * @param npairs number of index pairs in fromTo.
 */
  function mixChannels(src: InputArrayOfArrays, dst: InputOutputArrayOfArrays, fromTo: any, npairs: size_t): void
 ...
 * filled with zero .
 */
  function mixChannels(src: InputArrayOfArrays, dst: InputOutputArrayOfArrays, fromTo: any): void
 ...
 * or not (false).
 */
  function mulSpectrums(a: InputArray, b: InputArray, c: OutputArray, flags: int, conjB?: bool): void
 ...
 */
  function multiply(src1: InputArray, src2: InputArray, dst: OutputArray, scale?: double, dtype?: int): void
 ...
 * or CV_64F .
 */
  function mulTransposed(src: InputArray, dst: OutputArray, aTa: bool, delta?: InputArray, scale?: double, dtype?: int): void
 ...
 */
  function norm(src1: InputArray, normType?: int, mask?: InputArray): double
 ...
 * @param mask optional operation mask; it must have the same size as src1 and CV_8UC1 type.
 */
  function norm(src1: InputArray, src2: InputArray, normType?: int, mask?: InputArray): double
 ...
 * @param normType type of the norm (see NormTypes).
 */
  function norm(src: any, normType: int): double
 ...
 * @param mask optional operation mask.
 */
  function normalize(src: InputArray, dst: InputOutputArray, alpha?: double, beta?: double, norm_type?: int, dtype?: int, mask?: InputArray): void
 ...
 */
  function normalize(src: any, dst: any, alpha: double, normType: int): void

  function patchNaNs(a: InputOutputArray, val?: double): void

/**
 * wrap [PCA::backProject]
 */
  function PCABackProject(data: InputArray, mean: InputArray, eigenvectors: InputArray, result: OutputArray): void

/**
 * wrap PCA::operator()
 */
  function PCACompute(data: InputArray, mean: InputOutputArray, eigenvectors: OutputArray, maxComponents?: int): void

/**
 * wrap PCA::operator() and add eigenvalues output parameter
 */
  function PCACompute(data: InputArray, mean: InputOutputArray, eigenvectors: OutputArray, eigenvalues: OutputArray, maxComponents?: int): void

/**
 * wrap PCA::operator()
 */
  function PCACompute(data: InputArray, mean: InputOutputArray, eigenvectors: OutputArray, retainedVariance: double): void

/**
 * wrap PCA::operator() and add eigenvalues output parameter
 */
  function PCACompute(data: InputArray, mean: InputOutputArray, eigenvectors: OutputArray, eigenvalues: OutputArray, retainedVariance: double): void

/**
 * wrap [PCA::project]
 */
  function PCAProject(data: InputArray, mean: InputArray, eigenvectors: InputArray, result: OutputArray): void
 ...
 */
  function perspectiveTransform(src: InputArray, dst: OutputArray, m: InputArray): void
 ...
 * measured in radians.
 */
  function phase(x: InputArray, y: InputArray, angle: OutputArray, angleInDegrees?: bool): void
 ...
 * measured in radians.
 */
  function polarToCart(magnitude: InputArray, angle: InputArray, x: OutputArray, y: OutputArray, angleInDegrees?: bool): void
 ...
 * @param dst output array of the same size and type as src.
 */
  function pow(src: InputArray, power: double, dst: OutputArray): void
 ...
 */
  function PSNR(src1: InputArray, src2: InputArray, R?: double): double
 ...
 */
  function randn(dst: InputOutputArray, mean: InputArray, stddev: InputArray): void
 ...
 * instead.
 */
  function randShuffle(dst: InputOutputArray, iterFactor?: double, rng?: any): void
 ...
 */
  function randu(dst: InputOutputArray, low: InputArray, high: InputArray): void
 ...
 */
  function reduce(src: InputArray, dst: OutputArray, dim: int, rtype: int, dtype?: int): void
 ...
 */
  function repeat(src: InputArray, ny: int, nx: int, dst: OutputArray): void
 ...
 * @param nx Flag to specify how many times the src is repeated along the horizontal axis.
 */
  function repeat(src: any, ny: int, nx: int): Mat
 ...
 */
  function rotate(src: InputArray, dst: OutputArray, rotateCode: int): void
 ...
 * @param dst output array of the same size and type as src1.
 */
  function scaleAdd(src1: InputArray, alpha: double, src2: InputArray, dst: OutputArray): void
 ...
 */
  function setIdentity(mtx: InputOutputArray, s?: any): void
 ...
 */
  function solve(src1: InputArray, src2: InputArray, dst: OutputArray, flags?: int): bool
 ...
 */
  function solveCubic(coeffs: InputArray, roots: OutputArray): int
 ...
 */
  function solvePoly(coeffs: InputArray, roots: OutputArray, maxIters?: int): double
 ...
 */
  function sort(src: InputArray, dst: OutputArray, flags: int): void
 ...
 */
  function sortIdx(src: InputArray, dst: OutputArray, flags: int): void
 ...
 */
  function split(src: any, mvbegin: any): void
 ...
 */
  function split(m: InputArray, mv: OutputArrayOfArrays): void
 ...
 * @param dst output array of the same size and type as src.
 */
  function sqrt(src: InputArray, dst: OutputArray): void
 ...
 * @param dtype optional depth of the output array
 */
  function subtract(src1: InputArray, src2: InputArray, dst: OutputArray, mask?: InputArray, dtype?: int): void
 ...
 */
  function sum(src: InputArray): Scalar

/**
 * wrap [SVD::backSubst]
 */
  function SVBackSubst(w: InputArray, u: InputArray, vt: InputArray, rhs: InputArray, dst: OutputArray): void

/**
 * wrap [SVD::compute]
 */
  function SVDecomp(src: InputArray, w: OutputArray, u: OutputArray, vt: OutputArray, flags?: int): void
 ...
 */
  function trace(mtx: InputArray): Scalar
 ...
 */
  function transform(src: InputArray, dst: OutputArray, m: InputArray): void
 ...
 * @param dst output array of the same type as src.
 */
  function transpose(src: InputArray, dst: OutputArray): void
 ...
 * the src.
 */
  function vconcat(src: any, nsrc: size_t, dst: OutputArray): void
 ...
 */
  function vconcat(src1: InputArray, src2: InputArray, dst: OutputArray): void
 ...
 * the src. same depth.
 */
  function vconcat(src: InputArrayOfArrays, dst: OutputArray): void

  const BORDER_CONSTANT: BorderTypes // initializer: = 0

  const BORDER_REPLICATE: BorderTypes // initializer: = 1

  const BORDER_REFLECT: BorderTypes // initializer: = 2

  const BORDER_WRAP: BorderTypes // initializer: = 3

  const BORDER_REFLECT_101: BorderTypes // initializer: = 4

  const BORDER_TRANSPARENT: BorderTypes // initializer: = 5

  const BORDER_REFLECT101: BorderTypes // initializer: = BORDER_REFLECT_101

  const BORDER_DEFAULT: BorderTypes // initializer: = BORDER_REFLECT_101

  const BORDER_ISOLATED: BorderTypes // initializer: = 16

  const CMP_EQ: CmpTypes // initializer: = 0

  const CMP_GT: CmpTypes // initializer: = 1

  const CMP_GE: CmpTypes // initializer: = 2

  const CMP_LT: CmpTypes // initializer: = 3

  const CMP_LE: CmpTypes // initializer: = 4

  const CMP_NE: CmpTypes // initializer: = 5

/**
 * Gaussian elimination with the optimal pivot element chosen.
 * 
 */
  const DECOMP_LU: DecompTypes // initializer: = 0
 ...
 * 
 */
  const DECOMP_SVD: DecompTypes // initializer: = 1

/**
 * eigenvalue decomposition; the matrix src1 must be symmetrical
 * 
 */
  const DECOMP_EIG: DecompTypes // initializer: = 2

/**
 * Cholesky `$LL^T$` factorization; the matrix src1 must be symmetrical and positively defined
 * 
 */
  const DECOMP_CHOLESKY: DecompTypes // initializer: = 3

/**
 * QR factorization; the system can be over-defined and/or the matrix src1 can be singular
 * 
 */
  const DECOMP_QR: DecompTypes // initializer: = 4
 ...
 * 
 */
  const DECOMP_NORMAL: DecompTypes // initializer: = 16

/**
 * performs an inverse 1D or 2D transform instead of the default forward transform.
 * 
 */
  const DFT_INVERSE: DftFlags // initializer: = 1
 ...
 * 
 */
  const DFT_SCALE: DftFlags // initializer: = 2
 ...
 * 
 */
  const DFT_ROWS: DftFlags // initializer: = 4
 ...
 * 
 */
  const DFT_COMPLEX_OUTPUT: DftFlags // initializer: = 16
 ...
 * 
 */
  const DFT_REAL_OUTPUT: DftFlags // initializer: = 32
 ...
 * 
 */
  const DFT_COMPLEX_INPUT: DftFlags // initializer: = 64

/**
 * performs an inverse 1D or 2D transform instead of the default forward transform.
 * 
 */
  const DCT_INVERSE: DftFlags // initializer: = DFT_INVERSE
 ...
 * 
 */
  const DCT_ROWS: DftFlags // initializer: = DFT_ROWS

  const GEMM_1_T: GemmFlags // initializer: = 1

  const GEMM_2_T: GemmFlags // initializer: = 2

  const GEMM_3_T: GemmFlags // initializer: = 4
 ...
 * 
 */
  const NORM_INF: NormTypes // initializer: = 1
 ...
 * 
 */
  const NORM_L1: NormTypes // initializer: = 2
 ...
 * 
 */
  const NORM_L2: NormTypes // initializer: = 4
 ...
 * 
 */
  const NORM_L2SQR: NormTypes // initializer: = 5
 ...
 * 
 */
  const NORM_HAMMING: NormTypes // initializer: = 6
 ...
 * 
 */
  const NORM_HAMMING2: NormTypes // initializer: = 7

  const NORM_TYPE_MASK: NormTypes // initializer: = 7

  const NORM_RELATIVE: NormTypes // initializer: = 8

  const NORM_MINMAX: NormTypes // initializer: = 32

  const ROTATE_90_CLOCKWISE: RotateFlags // initializer: = 0

  const ROTATE_180: RotateFlags // initializer: = 1

  const ROTATE_90_COUNTERCLOCKWISE: RotateFlags // initializer: = 2
