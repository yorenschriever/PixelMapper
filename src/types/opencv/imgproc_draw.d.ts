 ...
 */
  function arrowedLine(img: InputOutputArray, pt1: Point, pt2: Point, color: any, thickness?: int, line_type?: int, shift?: int, tipLength?: double): void
 ...
 */
  function circle(img: InputOutputArray, center: Point, radius: int, color: any, thickness?: int, lineType?: int, shift?: int): void
 ...
 */
  function clipLine(imgSize: Size, pt1: any, pt2: any): bool
 ...
 * @param pt2 Second line point.
 */
  function clipLine(imgSize: Size2l, pt1: any, pt2: any): bool
 ...
 * @param pt2 Second line point.
 */
  function clipLine(imgRect: Rect, pt1: any, pt2: any): bool
 ...
 * $\texttt{offset}=(dx,dy)$ .
 */
  function drawContours(image: InputOutputArray, contours: InputArrayOfArrays, contourIdx: int, color: any, thickness?: int, lineType?: int, hierarchy?: InputArray, maxLevel?: int, offset?: Point): void
 ...
 * @param line_type Type of the line, See LineTypes
 */
  function drawMarker(img: InputOutputArray, position: Point, color: any, markerType?: int, markerSize?: int, thickness?: int, line_type?: int): void
 ...
 */
  function ellipse(img: InputOutputArray, center: Point, axes: Size, angle: double, startAngle: double, endAngle: double, color: any, thickness?: int, lineType?: int, shift?: int): void
 ...
 * @param lineType Type of the ellipse boundary. See LineTypes
 */
  function ellipse(img: InputOutputArray, box: any, color: any, thickness?: int, lineType?: int): void
 ...
 */
  function ellipse2Poly(center: Point, axes: Size, angle: int, arcStart: int, arcEnd: int, delta: int, pts: any): void
 ...
 * @param pts Output vector of polyline vertices.
 */
  function ellipse2Poly(center: Point2d, axes: Size2d, angle: int, arcStart: int, arcEnd: int, delta: int, pts: any): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function fillConvexPoly(img: InputOutputArray, pts: any, npts: int, color: any, lineType?: int, shift?: int): void
 ...
 */
  function fillConvexPoly(img: InputOutputArray, points: InputArray, color: any, lineType?: int, shift?: int): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function fillPoly(img: InputOutputArray, pts: any, npts: any, ncontours: int, color: any, lineType?: int, shift?: int, offset?: Point): void
 ...
 */
  function fillPoly(img: InputOutputArray, pts: InputArrayOfArrays, color: any, lineType?: int, shift?: int, offset?: Point): void
 ...
 */
  function getFontScaleFromHeight(fontFace: any, pixelHeight: any, thickness?: any): double
 ...
 */
  function getTextSize(text: any, fontFace: int, fontScale: double, thickness: int, baseLine: any): Size
 ...
 * @param shift Number of fractional bits in the point coordinates.
 */
  function line(img: InputOutputArray, pt1: Point, pt2: Point, color: any, thickness?: int, lineType?: int, shift?: int): void

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function polylines(img: InputOutputArray, pts: any, npts: any, ncontours: int, isClosed: bool, color: any, thickness?: int, lineType?: int, shift?: int): void
 ...
 * @param shift Number of fractional bits in the vertex coordinates.
 */
  function polylines(img: InputOutputArray, pts: InputArrayOfArrays, isClosed: bool, color: any, thickness?: int, lineType?: int, shift?: int): void
 ...
 */
  function putText(img: InputOutputArray, text: any, org: Point, fontFace: int, fontScale: double, color: Scalar, thickness?: int, lineType?: int, bottomLeftOrigin?: bool): void
 ...
 * @param shift Number of fractional bits in the point coordinates.
 */
  function rectangle(img: InputOutputArray, pt1: Point, pt2: Point, color: any, thickness?: int, lineType?: int, shift?: int): void
 ...
 */
  function rectangle(img: InputOutputArray, rec: Rect, color: any, thickness?: int, lineType?: int, shift?: int): void

  const FONT_HERSHEY_SIMPLEX: HersheyFonts // initializer: = 0

  const FONT_HERSHEY_PLAIN: HersheyFonts // initializer: = 1

  const FONT_HERSHEY_DUPLEX: HersheyFonts // initializer: = 2

  const FONT_HERSHEY_COMPLEX: HersheyFonts // initializer: = 3

  const FONT_HERSHEY_TRIPLEX: HersheyFonts // initializer: = 4

  const FONT_HERSHEY_COMPLEX_SMALL: HersheyFonts // initializer: = 5

  const FONT_HERSHEY_SCRIPT_SIMPLEX: HersheyFonts // initializer: = 6

  const FONT_HERSHEY_SCRIPT_COMPLEX: HersheyFonts // initializer: = 7

  const FONT_ITALIC: HersheyFonts // initializer: = 16

  const FILLED: LineTypes // initializer: = -1

  const LINE_4: LineTypes // initializer: = 4

  const LINE_8: LineTypes // initializer: = 8

  const LINE_AA: LineTypes // initializer: = 16

  const MARKER_CROSS: MarkerTypes // initializer: = 0

  const MARKER_TILTED_CROSS: MarkerTypes // initializer: = 1

  const MARKER_STAR: MarkerTypes // initializer: = 2

  const MARKER_DIAMOND: MarkerTypes // initializer: = 3

  const MARKER_SQUARE: MarkerTypes // initializer: = 4

  const MARKER_TRIANGLE_UP: MarkerTypes // initializer: = 5

  const MARKER_TRIANGLE_DOWN: MarkerTypes // initializer: = 6
