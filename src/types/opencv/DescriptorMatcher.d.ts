 ...
 * 
 */
 declare class DescriptorMatcher {
 ...
 declare const FLANNBASED: MatcherType // initializer: = 1

 declare const BRUTEFORCE: MatcherType // initializer: = 2

 declare const BRUTEFORCE_L1: MatcherType // initializer: = 3

 declare const BRUTEFORCE_HAMMING: MatcherType // initializer: = 4

 declare const BRUTEFORCE_HAMMINGLUT: MatcherType // initializer: = 5

 declare const BRUTEFORCE_SL2: MatcherType // initializer: = 6
