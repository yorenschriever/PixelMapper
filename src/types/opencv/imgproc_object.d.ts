 ...
 */
  function matchTemplate(image: InputArray, templ: InputArray, result: OutputArray, method: int, mask?: InputArray): void

  const TM_SQDIFF: TemplateMatchModes // initializer: = 0

  const TM_SQDIFF_NORMED: TemplateMatchModes // initializer: = 1

  const TM_CCORR: TemplateMatchModes // initializer: = 2

  const TM_CCORR_NORMED: TemplateMatchModes // initializer: = 3
 ...
 * 
 */
  const TM_CCOEFF: TemplateMatchModes // initializer: = 4

  const TM_CCOEFF_NORMED: TemplateMatchModes // initializer: = 5
