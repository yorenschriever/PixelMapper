...
declare namespace cv {
  ...
  const MAGIC_VAL: any // initializer: = 0x42FF0000
  const AUTO_STEP: any // initializer: = 0
  const CONTINUOUS_FLAG: any // initializer: = CV_MAT_CONT_FLAG
  const SUBMATRIX_FLAG: any // initializer: = CV_SUBMAT_FLAG
  const MAGIC_MASK: any // initializer: = 0xFFFF0000
  const TYPE_MASK: any // initializer: = 0x00000FFF
  const DEPTH_MASK: any // initializer: = 7
