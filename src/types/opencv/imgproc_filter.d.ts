 ...
 */
  function bilateralFilter(src: InputArray, dst: OutputArray, d: int, sigmaColor: double, sigmaSpace: double, borderType?: int): void
 ...
 * @param borderType border mode used to extrapolate pixels outside of the image, see BorderTypes
 */
  function blur(src: InputArray, dst: OutputArray, ksize: Size, anchor?: Point, borderType?: int): void
 ...
 * @param borderType border mode used to extrapolate pixels outside of the image, see BorderTypes
 */
  function boxFilter(src: InputArray, dst: OutputArray, ddepth: int, ksize: Size, anchor?: Point, normalize?: bool, borderType?: int): void
 ...
 */
  function buildPyramid(src: InputArray, dst: OutputArrayOfArrays, maxlevel: int, borderType?: int): void
 ...
 */
  function dilate(src: InputArray, dst: OutputArray, kernel: InputArray, anchor?: Point, iterations?: int, borderType?: int, borderValue?: any): void
 ...
 * @param borderValue border value in case of a constant border
 */
  function erode(src: InputArray, dst: OutputArray, kernel: InputArray, anchor?: Point, iterations?: int, borderType?: int, borderValue?: any): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes
 */
  function filter2D(src: InputArray, dst: OutputArray, ddepth: int, kernel: InputArray, anchor?: Point, delta?: double, borderType?: int): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes
 */
  function GaussianBlur(src: InputArray, dst: OutputArray, ksize: Size, sigmaX: double, sigmaY?: double, borderType?: int): void
 ...
 */
  function getDerivKernels(kx: OutputArray, ky: OutputArray, dx: int, dy: int, ksize: int, normalize?: bool, ktype?: int): void
 ...
 * @param ktype Type of filter coefficients. It can be CV_32F or CV_64F .
 */
  function getGaborKernel(ksize: Size, sigma: double, theta: double, lambd: double, gamma: double, psi?: double, ktype?: int): Mat
 ...
 * @param ktype Type of filter coefficients. It can be CV_32F or CV_64F .
 */
  function getGaussianKernel(ksize: int, sigma: double, ktype?: int): Mat
 ...
 * shifted.
 */
  function getStructuringElement(shape: int, ksize: Size, anchor?: Point): Mat
 ...
 * @param borderType Pixel extrapolation method, see BorderTypes
 */
  function Laplacian(src: InputArray, dst: OutputArray, ddepth: int, ksize?: int, scale?: double, delta?: double, borderType?: int): void
 ...
 */
  function medianBlur(src: InputArray, dst: OutputArray, ksize: int): void

  function morphologyDefaultBorderValue(): Scalar
 ...
 * meaning.
 */
  function morphologyEx(src: InputArray, dst: OutputArray, op: int, kernel: InputArray, anchor?: Point, iterations?: int, borderType?: int, borderValue?: any): void
 ...
 * @param borderType Pixel extrapolation method, see BorderTypes (BORDER_CONSTANT isn't supported)
 */
  function pyrDown(src: InputArray, dst: OutputArray, dstsize?: any, borderType?: int): void
 ...
 */
  function pyrMeanShiftFiltering(src: InputArray, dst: OutputArray, sp: double, sr: double, maxLevel?: int, termcrit?: TermCriteria): void
 ...
 */
  function pyrUp(src: InputArray, dst: OutputArray, dstsize?: any, borderType?: int): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes
 */
  function Scharr(src: InputArray, dst: OutputArray, ddepth: int, dx: int, dy: int, scale?: double, delta?: double, borderType?: int): void
 ...
 * @param borderType Pixel extrapolation method, see BorderTypes
 */
  function sepFilter2D(src: InputArray, dst: OutputArray, ddepth: int, kernelX: InputArray, kernelY: InputArray, anchor?: Point, delta?: double, borderType?: int): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes
 */
  function Sobel(src: InputArray, dst: OutputArray, ddepth: int, dx: int, dy: int, ksize?: int, scale?: double, delta?: double, borderType?: int): void
 ...
 * @param borderType pixel extrapolation method, see BorderTypes
 */
  function spatialGradient(src: InputArray, dx: OutputArray, dy: OutputArray, ksize?: int, borderType?: int): void
 ...
 * @param borderType border mode used to extrapolate pixels outside of the image, see BorderTypes
 */
  function sqrBoxFilter(src: InputArray, dst: OutputArray, ddepth: int, ksize: Size, anchor?: Point, normalize?: bool, borderType?: int): void

  const MORPH_RECT: MorphShapes // initializer: = 0
 ...
 * 
 */
  const MORPH_CROSS: MorphShapes // initializer: = 1
 ...
 * 
 */
  const MORPH_ELLIPSE: MorphShapes // initializer: = 2

  const MORPH_ERODE: MorphTypes // initializer: = 0

  const MORPH_DILATE: MorphTypes // initializer: = 1
 ...
 * 
 */
  const MORPH_OPEN: MorphTypes // initializer: = 2
 ...
 * 
 */
  const MORPH_CLOSE: MorphTypes // initializer: = 3
 ...
 * 
 */
  const MORPH_GRADIENT: MorphTypes // initializer: = 4
 ...
 * 
 */
  const MORPH_TOPHAT: MorphTypes // initializer: = 5
 ...
 * 
 */
  const MORPH_BLACKHAT: MorphTypes // initializer: = 6
 ...
 * 
 */
  const MORPH_HITMISS: MorphTypes // initializer: = 7

  const FILTER_SCHARR: SpecialFilter // initializer: = -1
