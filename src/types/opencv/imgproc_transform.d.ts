 ...
 */
  function convertMaps(map1: InputArray, map2: InputArray, dstmap1: OutputArray, dstmap2: OutputArray, dstmap1type: int, nninterpolation?: bool): void
 ...
 */
  function getAffineTransform(src: any, dst: any): Mat

  function getAffineTransform(src: InputArray, dst: InputArray): Mat
 ...
 */
  function getPerspectiveTransform(src: InputArray, dst: InputArray, solveMethod?: int): Mat

/**
 * This is an overloaded member function, provided for convenience. It differs from the above function
 * only in what argument(s) it accepts.
 */
  function getPerspectiveTransform(src: any, dst: any, solveMethod?: int): Mat
 ...
 */
  function getRectSubPix(image: InputArray, patchSize: Size, center: Point2f, patch: OutputArray, patchType?: int): void
 ...
 */
  function getRotationMatrix2D(center: Point2f, angle: double, scale: double): Mat
 ...
 */
  function invertAffineTransform(M: InputArray, iM: OutputArray): void

  function linearPolar(src: InputArray, dst: OutputArray, center: Point2f, maxRadius: double, flags: int): void

  function logPolar(src: InputArray, dst: OutputArray, center: Point2f, M: double, flags: int): void
 ...
 */
  function remap(src: InputArray, dst: OutputArray, map1: InputArray, map2: InputArray, interpolation: int, borderMode?: int, borderValue?: any): void
 ...
 */
  function resize(src: InputArray, dst: OutputArray, dsize: Size, fx?: double, fy?: double, interpolation?: int): void
 ...
 * @param borderValue value used in case of a constant border; by default, it is 0.
 */
  function warpAffine(src: InputArray, dst: OutputArray, M: InputArray, dsize: Size, flags?: int, borderMode?: int, borderValue?: any): void
 ...
 */
  function warpPerspective(src: InputArray, dst: OutputArray, M: InputArray, dsize: Size, flags?: int, borderMode?: int, borderValue?: any): void
 ...
 */
  function warpPolar(src: InputArray, dst: OutputArray, dsize: Size, center: Point2f, maxRadius: double, flags: int): void

/**
 * nearest neighbor interpolation
 * 
 */
  const INTER_NEAREST: InterpolationFlags // initializer: = 0

/**
 * bilinear interpolation
 * 
 */
  const INTER_LINEAR: InterpolationFlags // initializer: = 1

/**
 * bicubic interpolation
 * 
 */
  const INTER_CUBIC: InterpolationFlags // initializer: = 2
 ...
 * 
 */
  const INTER_AREA: InterpolationFlags // initializer: = 3

/**
 * Lanczos interpolation over 8x8 neighborhood
 * 
 */
  const INTER_LANCZOS4: InterpolationFlags // initializer: = 4

/**
 * Bit exact bilinear interpolation
 * 
 */
  const INTER_LINEAR_EXACT: InterpolationFlags // initializer: = 5

/**
 * mask for interpolation codes
 * 
 */
  const INTER_MAX: InterpolationFlags // initializer: = 7
 ...
 * 
 */
  const WARP_FILL_OUTLIERS: InterpolationFlags // initializer: = 8
 ...
 * 
 */
  const WARP_INVERSE_MAP: InterpolationFlags // initializer: = 16

  const INTER_BITS: InterpolationMasks // initializer: = 5

  const INTER_BITS2: InterpolationMasks // initializer: = INTER_BITS * 2

  const INTER_TAB_SIZE: InterpolationMasks // initializer: = 1 << INTER_BITS

  const INTER_TAB_SIZE2: InterpolationMasks // initializer: = INTER_TAB_SIZE * INTER_TAB_SIZE

  const WARP_POLAR_LINEAR: WarpPolarMode // initializer: = 0

  const WARP_POLAR_LOG: WarpPolarMode // initializer: = 256
